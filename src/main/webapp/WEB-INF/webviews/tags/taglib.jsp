...
<link rel="stylesheet" href="${ctx}/components/layui/css/layui.css" media="all">

<script type="text/javascript" src="${ctx}/components/jquery/jquery-1.10.2.min.js"></script>
<script type="text/javascript" src="${ctx}/components/layui/layui.js"></script>
<script type="text/javascript" src="${ctx}/components/Sha/js/Sha1.js"></script>
<script>
var ctx;
$(function(){
	init();
